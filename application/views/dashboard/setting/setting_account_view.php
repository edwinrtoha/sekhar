...
<div class="content-wrapper">
		...
		<section class="content">
			...
			<?php foreach($query->result() as $row){?>
				<form role="form" enctype="multipart/form-data" action="?act=update" method="post">
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="social-auth-links text-center">
													<a href="<?php echo base_url("login/oauth/connect/google");?>" class="btn btn-block btn-social btn-google"><i class="fa fa-google"></i> Connect with Google</a>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<div class="social-auth-links text-center">
													<a href="<?php echo base_url("login/oauth/connect/fb");?>" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Connect using Facebook</a>
												</div>
											</div>
										</div>
									</div>
