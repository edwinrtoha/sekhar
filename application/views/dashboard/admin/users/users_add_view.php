									...
									<div class="form-group">
										<div class="row">
											<div class="col-xs-6">
												...
												<input name="first_name" type="text" class="form-control" placeholder="nama">
											</div>
											<div class="col-xs-6">
												<label>Nama Belakang</label>
												<input name="last_name" type="text" class="form-control" placeholder="nama">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="row">
													...
													<?php foreach($query->result() as $prov){?>
														<optgroup label="<?php echo $prov->nama?>">
															...
															<?php foreach($kotas->result() as $kota){?>
																<option value="<?php echo $kota->id;?>"><?php echo ucwords(strtolower($kota->nama));?></option>
															<?php }?>
														</optgroup>
													<?php }?>
												</select>
											...
											<div class="col-md-9">
												<div class="input-group date">
													<input type="text" name="birth_date" class="form-control"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
												</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" name="first_balance" class="form-control" placeholder="Saldo Awal">
									</div>
								</div>
							</div>
						</div>
